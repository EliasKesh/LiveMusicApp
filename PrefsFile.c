...
//       { "Drums", 128, 26, FluidPort, 1, NoCustom, 0 },
        ...
        { "LP 1", 0xff, 70, LooperPort, 1, NoCustom, 116 },
        { "LP 2", 0xff, 71, LooperPort, 1, NoCustom, 116 },
        { "LP 3", 0xff, 72, LooperPort, 1, NoCustom, 116 },
        { "LP 4", 0xff, 73, LooperPort, 1, NoCustom, 116 },
        { "LP Rec", 0xff, 74, LooperPort, 1, NoCustom, 116 },
