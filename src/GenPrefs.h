...
/*   4 */ {"Juicy",           NoBank         ,   6, GuitarixPort   ,   1, NoCustom  , "None" },
...
/*   Num   Name,              Bank         , Patch, Outport    ,  Channel, Custom,    Chain */ 
/*  10 */ {"Mel Tog",         NoBank         ,  13, GuitarixPort   ,   1, cmdSendCC , "None" },
/*  11 */ {"Expr Vol",        NoBank         ,   7, GuitarixPort   ,   1, cmdSetExpr, "None" },
/*  12 */ {"Expr Wah",        NoBank         ,  11, GuitarixPort   ,   1, cmdSetExpr, "None" },
/*  13 */ {"Expr Dist",       NoBank         ,   2, GuitarixPort   ,   1, cmdSetExpr, "None" },
/*  14 */ {"Transport ****",  NoBank         ,   0, InternalPort   ,   1, RaiseApp  , "None" },
/*  15 */ {"TransStart",      NoBank         ,   0, TransportPort  ,   1, TransStart, "None" },
/*  16 */ {"TransCont",       NoBank         ,   0, TransportPort  ,   1, TransCont , "None" },
/*  17 */ {"TransStop",       NoBank         ,   0, TransportPort  ,   1, TransStop , "None" },
/*  18 */ {"TransBack",       NoBank         ,   0, TransportPort  ,   1, TransStart, "None" },
/*  19 */ {"Tap",             NoBank         , 121, InternalPort   ,   1, Controller, "None" },
/*   Num   Name,              Bank         , Patch, Outport    ,  Channel, Custom,    Chain */ 
