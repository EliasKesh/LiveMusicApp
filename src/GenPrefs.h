...
/*  24 */ {"Tap",             NoBank         , 121, InternalPort   ,   1, cmdController, "None" },
/*  25 */ {"TransPos",        NoBank         ,   0, TransportPort  ,   1, TransStart, "None" },
/*  26 */ {"Tap",             NoBank         , 121, InternalPort   ,   1, cmdController, "None" },
/*  27 */ {"Midi Tog",        NoBank         , 122, FluidPort      ,   1, cmdController, "None" },
/*  28 */ {"Tuner",           NoBank         , 123, FluidPort      ,   1, cmdController, "None" },
/*  29 */ {"AnaOnOff",        NoBank         , 124, FluidPort      ,   1, cmdController, "None" },
/*   Num   Name,              Bank         , Patch, Outport    ,  Channel, Custom,    Chain */ 
