...
//					system("/usr/bin/smplayer -send-action set_b_marker & ");
		...
		case cmdSendCC:
			...
			*/
			case cmdSetExpr:
				gMyInfo.ExpreP1Out = thePatch->Patch;
				gMyInfo.ExpreP1Port = thePatch->OutPort;
			break;
...
//	msg_str_ptr = g_string_new("unknown event");
			...
			case SND_SEQ_EVENT_CONTROLLER:
				...
				case MIDI_CTL_MSB_MAIN_VOLUME:
					...
					SendMidi(SND_SEQ_EVENT_CONTROLLER, gMyInfo.ExpreP1Port, 1, gMyInfo.ExpreP1Out,
					   event_ptr->data.control.value);
