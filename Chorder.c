...
ChordMenu myChordMenu[] = { { chMajor, "Major Chord" },
		{ chMinor, "Minor Chord" }, { chDominant, "Dominant Chord" }, {
				chMajor6, "Major 6" }, { chMinor6, "Minor 6" }, { chMajor9,
				"Major 9" }, { chMinor9, "Minor 9" }, { chDom9, "Dom 9" }, {
				ch69, "Dom 69" }, { scMajor, "Major Scale" }, { scMinor,
				"Minor Scale" }, { scHemiPent, "Hemi Pent" }, { scMajPent,
				"Maj Pent" }, { scMinPent, "Min Pent" }, { NULL, "Opps" }

};

thePreChord pchMaj[] = {
/* S  Fi D Fr     S  Fi D Fr     S  Fi D Fr     S  Fi D Fr	*/
{ 1, 1, 1, 0 }, { 2, 3, 5, 2 }, { 3, 4, 1, 2 }, { 4, 2, 3, 1 },
		{ -1, -1, -1, -1 } };
thePreChord pchMin[] = {
/* S  Fi D Fr     S  Fi D Fr     S  Fi D Fr     S  Fi D Fr	*/
{ 1, 1, 1, 0 }, { 2, 3, 5, 2 }, { 3, 4, 1, 2 }, { 4, 2, 3, 0 },
		{ -1, -1, -1, -1 } };

thePreChord pchMaj7[] = {
/* S  Fi D Fr     S  Fi D Fr     S  Fi  D  Fr    S  Fi D  Fr	*/
{ 1, 2, 1, 0 }, { 2, 3, 3, -1 }, { 3, 3, 7, 1 }, { 4, 4, 3, 1 }, { -1, -1, -1,
		-1 } };
thePreChord pchMin7[] = {
/* S  Fi D Fr     S  Fi D Fr     S  Fi  D  Fr    S  Fi D  Fr	*/
{ 1, 2, 1, 0 }, { 2, 3, 3, -2 }, { 3, 3, 7, 0 }, { 4, 4, 3, 0 }, { -1, -1, -1,
		-1 } };
...
PreChordMenu myPreChordMenu[] = { { pchMaj, "Maj" }, { pchMin, "Min" }, {
		pchMaj7, "Maj7" }, { pchMin7, "Min7" }, { pchMaj7O, "Maj7 Open" }, {
		pchMin7O, "Min7 Open" }, { NULL, "Opps" } };
...
char *FlatNotes[12] = { "A ", "Bb", "B ", "C ", "Db", "D ", "Eb", "E ", "F ",
		"Gb ", "G ", "Ab" };
...
//	Fingerboard = gdk_pixbuf_new_from_file(ResourceDirectory"./wood.png", &err);
	...
	BouncieBallBl = gdk_pixbuf_new_from_file(ResourceDirectory"blueball.png",
			&err);
	BouncieBallGr = gdk_pixbuf_new_from_file(ResourceDirectory"greenball.png",
			&err);
	BouncieBallRed = gdk_pixbuf_new_from_file(ResourceDirectory"redball.png",
			&err);
	BouncieBallYel = gdk_pixbuf_new_from_file(ResourceDirectory"yelball.png",
			&err);
